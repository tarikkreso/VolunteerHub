...
{
    /// <inheritdoc />
    public partial class AddIdentityAndNewSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VolunteerHistories_Campaigns_CampaignId",
                        column: x => x.CampaignId,
                        principalTable: "Campaigns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_VolunteerHistories_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_VolunteerHistories_Shifts_ShiftId",
                        column: x => x.ShiftId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VolunteerHistories_CampaignId",
                table: "VolunteerHistories",
                column: "CampaignId");

            migrationBuilder.CreateIndex(
                name: "IX_VolunteerHistories_EventId",
                table: "VolunteerHistories",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_VolunteerHistories_ShiftId",
                table: "VolunteerHistories",
                column: "ShiftId");
